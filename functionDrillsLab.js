...
////////////////// PROBLEM 12 ////////////////////
/*
  Write a function, naming it whatever you believe to be appropriate, that buys as many chocolate frogs as possible with a certain amount
  of gold. Each chocolate frog costs 3 gold. Your function should take in a single parameter, which is the amount of gold you are 
  willing to spend. Your function should return a total amount of chocolate frogs you were able to purchase.
  Create a variable called `totalFrogs` and set it equal to your function invoked, passing in the amount of gold you are willing to spend.
*/

//CODE HERE

function theTrolley(netWorth){
 let frogCost = 3 //I realize this bit of code is techincally redundant. might be useful in the future though.
 return netWorth / frogCost
}
let totalFrogs = theTrolley(270)
console.log(totalFrogs)
//YES, I'm willing to spend my entire net worth on chocolate frogs.
...
function theTrolley2(netWorth){
  let frogCost = 3
  let remainder = netWorth % frogCost            //Yes, I could use math.floor - But what if I wanted the change from my transaction?
  return (netWorth - remainder) / frogCost
}

 let totalFrogs2 = theTrolley2(7)
...
/*
  ...
  false if it is not. Create a variable, `arrayIsAscending` and set it equal to your function invoked. Use the sample array to test 
  this function.
*/
